...
try {
  ...
  await click('.crew-me')
  await sleep(1500)
  const d1 = await click('.friends-danger .gbtn')
  await sleep(600)
  const d2 = await click('.friends-danger .gbtn.armed')
  ...
  await click('.crew-me')
  await sleep(1500)
  await click('.friends-danger .gbtn')
  await sleep(600)
  await click('.friends-danger .gbtn.armed')
